...
@CloudstreamPlugin
open class ShakzzVersePlugin: Plugin() {
    override fun load(context: Context) {
        ...
        val sharedPref = context.getSharedPreferences("ShakzzVerseStudios", Context.MODE_PRIVATE)
        ...
        openSettings = {
            val frag = ShakzzVerseSettings(this, sharedPref, studioOptions)
            frag.show(activity.supportFragmentManager, "ShakzzVerseSettings")
        }
    }
