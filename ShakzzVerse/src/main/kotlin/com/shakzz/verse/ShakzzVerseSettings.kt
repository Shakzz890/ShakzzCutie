...
class ShakzzVerseSettings(
    ...
    private fun getDrawable(name: String): Drawable? {
        val id = plugin.resources?.getIdentifier(name, "drawable", "com.Shakzzverse")
    ...
    private fun getString(name: String): String? {
        val id = plugin.resources?.getIdentifier(name, "string", "com.Shakzzverse")
    ...
    private fun <T : View> View.findViewByName(name: String): T? {
        val id = plugin.resources?.getIdentifier(name, "id", "com.Shakzzverse")
    ...
    override fun onCreateView(
        ...
        val layoutId = plugin.resources?.getIdentifier("settings", "layout", "com.Shakzzverse")
        return layoutId?.let {
