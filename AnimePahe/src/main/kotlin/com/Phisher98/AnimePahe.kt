...
class AnimePahe : MainAPI() {
    companion object {
        ...
        private val Proxy="https://animepaheproxy.shakzzanimepahe.workers.dev/?url="
...
//            @JsonProperty("anime_slug") val animeSlug: String,
    ...
    private suspend fun generateListOfEpisodes(session: String): ArrayList<Episode> {
        ...
        try {
            val uri = "https://animepaheproxy.shakzzanimepahe.workers.dev/?url=$mainUrl/api?m=release&id=$session&sort=episode_asc&page=1"
